...
def main():
	selection = -1
        ...
        print("1. BSO Starwars")
        print("2. Ordenes basicas")
        print("3. Lectura de sensores")
        print("4. Control de actuadores")
        print("5. SLAM")
        print("6. Custom program")
        ...
        if (selection == 1):
                ...
                robot._start() #Iniciamos el roomba
                robot.toSafeMode()
                play_starwars(robot)
                robot.close()
        if (selection == 2):
                ...
                robot._start() #Iniciamos el roomba
                robot.toSafeMode()
                robot._write(chr(136)) #Inicia un cicli largo de limpieza
                robot.close()
                ...
                robot._start() #Iniciamos el roomba
                robot.toSafeMode()
                robot._drive(250,500) #Suponemos que hace un giro
                ...
                print("Opcion no valida, vuelva a seleccionar:")
                repetir = true
